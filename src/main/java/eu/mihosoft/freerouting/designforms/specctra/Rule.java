...
public abstract class Rule
{
    ...
    public static void write_scope(eu.mihosoft.freerouting.rules.NetClass p_net_class, WriteScopeParameter p_par) throws java.io.IOException
    {
    ...
    private static void write_layer_rule(eu.mihosoft.freerouting.rules.NetClass p_net_class, int p_layer_no, WriteScopeParameter p_par) throws java.io.IOException
    {
        p_par.file.start_scope();
        p_par.file.write("layer_rule ");
        
        eu.mihosoft.freerouting.board.Layer curr_board_layer = p_par.board.layer_structure.arr[p_layer_no];
    ...
    {
        eu.mihosoft.freerouting.rules.ClearanceMatrix cl_matrix = p_par.board.rules.clearance_matrix;
    ...
    static public void write_item_clearance_class( String p_name, eu.mihosoft.freerouting.datastructures.IndentFileWriter p_file,
            eu.mihosoft.freerouting.datastructures.IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.new_line();
