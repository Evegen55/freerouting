...
public class DragItemState extends DragState
{
    ...
    {
        hdlg.screen_messages.setStatusMessage(resources.getString("dragging_item"));
    }
    ...
    public InteractiveState move_to(FloatPoint p_to_location)
    {
        ...
        {
            hdlg.screen_messages.setStatusMessage("Please unfix item before dragging");
            return this;
        }
    ...
    public InteractiveState button_released()
    {
        ...
        if (something_dragged)
        {
            ...
            {
                Collection<Item> moved_items =  hdlg.getRoutingBoard().get_component_items(item_to_move.get_component_no());
