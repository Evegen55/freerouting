...
public class CoordinateTransform implements Serializable {
    ...
    public CoordinateTransform(double p_user_unit_factor, Unit p_user_unit,
        ...
        scale_factor = board_unit_factor / userUnitFactor;
    }
    ...
    public double board_to_user(double p_value) {
        return Unit.scale(p_value * scale_factor, board_unit, userUnit);
    }
    ...
    public double user_to_board(double p_value) {
        return Unit.scale(p_value / scale_factor, userUnit, board_unit);
    }
