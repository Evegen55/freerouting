...
public class WindowVia extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("eu.mihosoft.freerouting.gui.WindowVia", p_board_frame.get_locale());
    ...
    private class AddPadstackListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            {
                Layer[] possible_start_layers = new  eu.mihosoft.freerouting.board.Layer[pcb.layer_structure.arr.length - 1];
            ...
            if (!layers_selected)
            {
                ...
                Layer[] possible_end_layers = new  eu.mihosoft.freerouting.board.Layer[pcb.layer_structure.arr.length - first_possible_end_layer_no];
            ...
            for (int i = from_layer_no; i <= to_layer_no; ++i)
            {
                ...
                if (circle_radius > 0)
                {
                    padstack_shapes[i] = new  eu.mihosoft.freerouting.geometry.planar.Circle(eu.mihosoft.freerouting.geometry.planar.Point.ZERO, circle_radius);
                    shape_exists = true;
                }
            }
            if (!shape_exists)
            ...
            eu.mihosoft.freerouting.library.Padstack new_padstack = pcb.library.padstacks.add(padstack_name, padstack_shapes, true, true);
    ...
    private class RemovePadstackListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            eu.mihosoft.freerouting.library.Padstack selected_padstack = (eu.mihosoft.freerouting.library.Padstack)selected_value;
            eu.mihosoft.freerouting.rules.ViaInfo via_with_selected_padstack = null;
