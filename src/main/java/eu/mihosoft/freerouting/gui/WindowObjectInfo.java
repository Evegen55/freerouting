 ...
 * @author Alfons Wirtz
 */
public class WindowObjectInfo extends BoardTemporarySubWindow implements eu.mihosoft.freerouting.board.ObjectInfoPanel
{
    /**
    ...
    public static void display(Collection<eu.mihosoft.freerouting.board.Item> p_item_list,
                               BoardFrame p_board_frame, eu.mihosoft.freerouting.board.CoordinateTransform p_coordinate_transform, java.awt.Point p_location)
    {
        ...
        for (WindowObjectInfo.Printable curr_object : p_item_list)
        {
            ...
            if (curr_object instanceof eu.mihosoft.freerouting.board.Pin)
            {
                ++pin_count;
            }
            else if (curr_object instanceof eu.mihosoft.freerouting.board.Via)
            {
                ++via_count;
            }
            else if (curr_object instanceof eu.mihosoft.freerouting.board.Trace)
            {
                ++trace_count;
                cumulative_trace_length += ((eu.mihosoft.freerouting.board.Trace) curr_object).get_length();
            }
        }
    ...
    public static WindowObjectInfo display(String p_title, Collection<Printable> p_object_list,
            BoardFrame p_board_frame, eu.mihosoft.freerouting.board.CoordinateTransform p_coordinate_transform)
    {
    ...
    private WindowObjectInfo(BoardFrame p_board_frame, eu.mihosoft.freerouting.board.CoordinateTransform p_coordinate_transform)
    {
        super(p_board_frame);
        this.resources = 
     ...
     * Returns false, if that was not possible.
     */
    public boolean append(eu.mihosoft.freerouting.geometry.planar.Shape p_shape, java.util.Locale p_locale)
    {
        eu.mihosoft.freerouting.board.PrintableShape transformed_shape = this.coordinate_transform.board_to_user(p_shape, p_locale);
     ...
     */
    public boolean append_items( String p_button_name, String p_window_title, java.util.Collection<eu.mihosoft.freerouting.board.Item> p_items)
    {
        java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<WindowObjectInfo.Printable>();
    ...
    private final eu.mihosoft.freerouting.board.CoordinateTransform coordinate_transform;
