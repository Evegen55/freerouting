...
public class WindowEditVias extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("eu.mihosoft.freerouting.gui.WindowEditVias", p_board_frame.get_locale());
    ...
    private class AddViaListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            eu.mihosoft.freerouting.rules.NetClass default_net_class = routing_board.rules.get_default_net_class();
            ViaInfo new_via = new ViaInfo(new_name, routing_board.library.get_via_padstack(0),
                    default_net_class.default_item_clearance_classes.get(eu.mihosoft.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA),
