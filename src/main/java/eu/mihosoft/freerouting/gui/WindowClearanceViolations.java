...
import eu.mihosoft.freerouting.interactive.ClearanceViolations;
...
public class WindowClearanceViolations extends WindowObjectListWithFilter
{
    ...
    private String item_info(eu.mihosoft.freerouting.board.Item p_item)
    {
        String result;
        ...
        else if (p_item instanceof eu.mihosoft.freerouting.board.BoardOutline)
        {
