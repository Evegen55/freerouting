...
public class WindowNets extends WindowObjectListWithFilter
{
    ...
    private class AssignClassListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            if (!(selected_value instanceof eu.mihosoft.freerouting.rules.NetClass))
            {
                return;
            }
            eu.mihosoft.freerouting.rules.NetClass selected_class = (eu.mihosoft.freerouting.rules.NetClass) selected_value;
            for (int i = 0; i < selected_nets.size(); ++i)
            {
