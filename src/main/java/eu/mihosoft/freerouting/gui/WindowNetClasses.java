...
public class WindowNetClasses extends BoardSavableSubWindow
{
    ...
    private class RemoveNetClassListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            {
                eu.mihosoft.freerouting.rules.Net curr_net = board_rules.nets.get(i);
    ...
    private class SelectClassesListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            eu.mihosoft.freerouting.rules.Nets nets = routing_board.rules.nets;
            ...
            for (eu.mihosoft.freerouting.board.Item curr_item : board_items)
            {
                ...
                {
                    eu.mihosoft.freerouting.rules.NetClass curr_net_class = nets.get(curr_item.get_net_no(i)).get_class();
