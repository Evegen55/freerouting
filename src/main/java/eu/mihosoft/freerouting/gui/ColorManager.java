...
public class ColorManager extends BoardSavableSubWindow {
    ...
    public ColorManager(BoardFrame p_board_frame) {
        GraphicsContext graphics_context = p_board_frame.boardPanel.boardHandling.graphicsContext;
        ...
        p_board_frame.setContextSensitiveHelp(this, "WindowDisplay_Colors");
        this.pack();
    ...
    /**
     * The editor button that brings up the dialog. We extend DefaultCellEditor for convenience, even though it mean we
     * have to create a dummy check box.  Another approach would be to copy the implementation of TableCellEditor
