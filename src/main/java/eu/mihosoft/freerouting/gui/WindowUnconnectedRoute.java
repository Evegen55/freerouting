...
public class WindowUnconnectedRoute extends WindowObjectListWithFilter
{
    ...
    protected void fill_list()
    {
        ...
        {
            if (!(curr_item instanceof eu.mihosoft.freerouting.board.Trace || curr_item instanceof eu.mihosoft.freerouting.board.Via))
            {
                continue;
            }
            ...
            for (Item curr_connnected_item : curr_connected_set)
            {
                ...
                if (!(curr_connnected_item instanceof eu.mihosoft.freerouting.board.Trace || curr_connnected_item instanceof eu.mihosoft.freerouting.board.Via))
                {
            ...
            if (!terminal_item_found)
            {
                ...
                {
                    eu.mihosoft.freerouting.rules.Net curr_net = routing_board.rules.nets.get(curr_item.get_net_no(0));
                    if (curr_net != null)
                    {
    ...
    {
        public UnconnectedRouteInfo(eu.mihosoft.freerouting.rules.Net p_net, Collection<Item> p_item_list)
        {
            this.net = p_net;
            ...
            for (Item curr_item: p_item_list)
            {
                ...
                else if (curr_item instanceof eu.mihosoft.freerouting.board.Via)
                {
                    ++curr_via_count;
                }
            }
        ...
        private final eu.mihosoft.freerouting.rules.Net net;
