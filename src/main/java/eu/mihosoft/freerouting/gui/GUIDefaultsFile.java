...
public class GUIDefaultsFile
{
     ...
     */
    public static boolean write(BoardFrame p_board_frame,
                                eu.mihosoft.freerouting.interactive.BoardHandling p_board_handling, java.io.OutputStream p_output_stream)
    {
    ...
    public static boolean read(BoardFrame p_board_frame,
                               eu.mihosoft.freerouting.interactive.BoardHandling p_board_handling, java.io.InputStream p_input_stream)
    {
    ...
    private GUIDefaultsFile(BoardFrame p_board_frame, eu.mihosoft.freerouting.interactive.BoardHandling p_board_handling,
    ...
    {
        eu.mihosoft.freerouting.interactive.SnapShot.Attributes attributes = this.board_handling.settings.get_snapshot_attributes();
        out_file.start_scope();
