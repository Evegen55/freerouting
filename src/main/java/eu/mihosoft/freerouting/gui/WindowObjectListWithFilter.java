...
/**
 * Abstract class for windows displaying a list of objects The object name can be filttered by an alphanumeric input
 * string. * @author Alfons Wirtz
 */
public abstract class WindowObjectListWithFilter extends WindowObjectList {
    ...
    public void setSnapshotInfo(SnapshotInfo p_snapshot_info) {
