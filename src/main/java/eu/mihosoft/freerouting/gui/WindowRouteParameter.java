...
public class WindowRouteParameter extends BoardSavableSubWindow
{
    ...
    public void refresh()
    {
        ...
        else if (snap_angle == eu.mihosoft.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE)
        {
    ...
    private class SnapAngle90Listener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            {
                if (curr_trace instanceof eu.mihosoft.freerouting.board.PolylineTrace)
                {
                    if (!((eu.mihosoft.freerouting.board.PolylineTrace)curr_trace).polyline().is_orthogonal())
                    {
            ...
            {
                java.util.ResourceBundle resources = 
                        java.util.ResourceBundle.getBundle("eu.mihosoft.freerouting.gui.WindowRouteParameter", current_locale);
            ...
            board_handling.set_current_snap_angle(eu.mihosoft.freerouting.board.AngleRestriction.NINETY_DEGREE);
        }
    }
    ...
    private class SnapAngle45Listener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            for (eu.mihosoft.freerouting.board.Trace curr_trace : trace_list)
            {
                if (curr_trace instanceof eu.mihosoft.freerouting.board.PolylineTrace)
                {
                    if (!((eu.mihosoft.freerouting.board.PolylineTrace)curr_trace).polyline().is_multiple_of_45_degree())
                    {
                        free_angle_traces_found = true;
                        break;
                    }
            ...
            board_handling.set_current_snap_angle(eu.mihosoft.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE);
        }
    }
    ...
    private class SnapAngleNoneListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            board_handling.set_current_snap_angle(eu.mihosoft.freerouting.board.AngleRestriction.NONE);
        }
    }
